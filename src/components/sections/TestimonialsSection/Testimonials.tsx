...
const Testimonials = () => (
  <div className="pt-12 grid grid-cols-3 grid-rows-1 gap-x-12">
    ...
    >
      &ldquo;During his time at Tracestory, Lucas demonstrated a great capacity
      for learning and adaptation, both to the different tasks requested and to
      the needs and challenges linked to the product. At all times he was
      committed to the team and to maintaining a high standard in his
      results.&rdquo;
    </Testimonial>
    <Testimonial
      image="nicolas.jpeg"
    ...
    >
      &ldquo;Lucas is an incredible young professional. He has demonstrated that
      he can overcome any obstacle by utilizing his heuristics. He is also a
    ...
    >
      &ldquo;I had the opportunity to work with Lucas for a short time, but it
      was enough to recognize his strong skills as a developer and his
